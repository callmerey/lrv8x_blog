                            ...
                            <div class="flex flex-row flex-wrap items-center">
                                <div
                                    ...
                                    <a class="block w-full h-auto relative undefined" data-title="false"><img
                                            src="{{url('public/uploads/')}}/{{$image_user}}"
                                            data-sizes="auto" loading="lazy"
                                            data-src="{{url('public/uploads/')}}/{{$image_user}}"
                                            data-width="400" data-height="400" alt="{{$name}}"
                                ...
                                <div class="w-full pr-10 md:flex-1 lg:w-auto">
                                    ...
                                    <div class="flex flex-row flex-wrap items-center mt-6"><button
                                            class="flex flex-row items-center button-transparent"><svg
                                                class="w-5 h-5 mr-2 fill-current" viewBox="0 0 512 512">
                                                <path
                                            ...
                                            </svg><span>Hồ Sơ</span></button></div>
                                </div>
                            </div>
                            <div
                                ...
                                <a 
                                    href="profile" class="px-6 py-2 border-b-2 border-transparent hover:bg-brand-grey-100 dark:hover:bg-brand-grey-700 border-accent-blue-A700">Bài Viết
                                    </a>
                                <a
