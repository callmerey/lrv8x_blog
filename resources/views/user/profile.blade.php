                    ...
                    <div class="flex flex-row items-center justify-between pt-4">
                        <div class="flex flex-row items-center justify-between w-full">
                            ...
                            <div class="flex flex-row items-center">
                                ...
                                <div class="relative">
                                    <a onclick="deleteItem('{{ $post->post_id }}');" aria-label="Bookmark this post"
                                        data-title="Delete Post"
                                        class="bookmark-button flex flex-row items-center focus:outline-none p-2 rounded hover:bg-brand-grey-100 dark:hover:bg-brand-dark-grey-700 tooltip-handle  tooltip-left-aligned text-brand-grey-700 dark:text-brand-grey-300 ">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-calendar-x" viewBox="0 0 16 16">
...
<script>
    function deleteItem(id) {
        ...
        if (r == true) {
            document.location.href = 'http://localhost/lrv8x_blog/delete/'+id
        } else {
