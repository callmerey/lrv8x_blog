                    ...
                    <div class="flex flex-row flex-wrap w-full">
                        <div class="flex-shrink-0 w-full pr-2 lg:w-84 lg:pl-0 lg:pr-4">
                            <div
                                ...
                                <h1 class="text-2xl font-bold">{{__('messages.profile_user')}}</h1>
                            </div>
                            <div
                                ...
                                <a class="px-3 md:px-6 py-4 w-full flex flex-row items-center text-accent-blue-A700"
                                    ...
                                    </svg><span>{{__('messages.email_user')}}</span></a><a
                                    class="px-3 md:px-6 py-4 w-full flex flex-row items-center hover:bg-brand-grey-100 dark:hover:bg-brand-dark-grey-700"
                                    ...
                                    </svg><span>{{__('messages.publications')}}</span></a><a
                                    class="px-3 md:px-6 py-4 w-full flex flex-row items-center hover:bg-brand-grey-100 dark:hover:bg-brand-dark-grey-700"
                                    ...
                                    </svg><span>{{__('messages.dev')}}</span></a><a
                                    ...
                                    </svg><span>{{__('messages.account')}}</span></a>
                            </div>
                        </div>
                        <form class="flex-1" action="{{url('user/'.$user->id)}}" method="POST" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="flex-1">
                                @if (Session::get('msg'))
