                    ...
                    <div class="w-full max-w-full ">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <a
                                    class="px-6 py-2 border-b-2 border-transparent hover:bg-brand-grey-100 dark:hover:bg-brand-grey-700 border-accent-blue-A700">POST</a>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="overflow-hidden border rounded-t-lg dark:border-brand-grey-800">
                                    <div
                                        ...
                                        <div class="p-5">
                                            ...
                                            <form class="user" action="{{ route('post/save') }}" method="POST"
