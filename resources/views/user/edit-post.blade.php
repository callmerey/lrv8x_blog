                ...
                <div class="z-40 col-span-12 md:col-span-9 lg:col-span-10 xl:col-span-8">
                    <div class="w-full max-w-full ">
                        <div class="bg-white bg-center bg-cover border-l border-r profile-cover dark:border-brand-grey-800 dark:bg-brand-grey-900"
                            style="background-image: url({{url('public/uploads/')}}/{{$image_background}});">
                        </div>
                        <div
                                            ...
                                            <form class="user" action="{{ url('save-post/' . $post->post_id) }}"
                                                ...
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-user"
                                                        ...
                                                        placeholder="Tiêu đề bài viết" value="{{ $post->name_post }}"
                                                        name="name_post" value="{{ old('name_post') }}">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-user"
                                                        id="exampleInputEmail" aria-describedby="emailHelp"
                                                        placeholder="Mô tả bài viết" value="{{ $post->desc }}"
                                                    ...
                                                    <select name="cate_id" class="form-control custom-select">
                                                        @foreach ($items as $cate)
                                                            <option value="{{ $cate->cate_id }}"
                                                                {{ $cate->cate_id == $post->cate_id ? 'selected' : '' }}>
                                                                {{ $cate->cate_name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
